...
class ImageModel(private val context: Context) {
    ...
    private val getPhotoTask = ObservableOnSubscribe<Any> {
        ...
        cursor?.let {
            ...
            while (cursor.moveToNext()) {
                ...
                val photo = Image(id, path, name, modifyDate, folderName)
                photoList.add(photo)
     ...
     * 增加所有照片选项
     */
    private fun addAllPhotoFolder(folderList: MutableList<Folder>, photoList: List<Image>) {
