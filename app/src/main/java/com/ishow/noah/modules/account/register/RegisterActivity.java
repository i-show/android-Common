...
public class RegisterActivity extends AppBaseActivity implements View.OnClickListener, RegisterContract.View {
    ...
    protected void initViews() {
        ...
        mInputPhone = findViewById(R.id.phone);
        mInputVerify = findViewById(R.id.verify_code);
        mInputPassword = findViewById(R.id.password);
        mInputPasswordEnsure = findViewById(R.id.ensure_password);

        mVerifyCodeButton = findViewById(R.id.send_verify_code);
