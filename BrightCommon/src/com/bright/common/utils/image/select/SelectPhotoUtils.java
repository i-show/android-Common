...
public abstract class SelectPhotoUtils implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public class Request {
         ...
         * 单选调用摄像头
         */
        public static final int REQUEST_SINGLE_CAMERA = 1 << Shift.UTILS;
        /**
         * 多选调用摄像头
         */
        public static final int REQUEST_MULTI_CAMERA = REQUEST_SINGLE_CAMERA + 1;
        /**
         * 单选图片
         */
        public static final int REQUEST_SINGLE_PICK = REQUEST_SINGLE_CAMERA + 2;
        /**
         * 多选图片
         */
        public static final int REQUEST_MULTI_PICK = REQUEST_SINGLE_CAMERA + 3;
        public static final int REQUEST_CROP = REQUEST_SINGLE_CAMERA + 4;
    }
}
