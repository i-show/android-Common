...
public class XListView extends ListView implements IPullToRefresh, OnScrollListener {
    ...
    private void initWithContext(Context context, AttributeSet attrs) {
        ...
        int headerLineVisibility = a.getInt(R.styleable.XListView_headerLineVisibility, View.VISIBLE);
        int footerLineVisibility = a.getInt(R.styleable.XListView_footerLineVisibility, View.VISIBLE);
        hasEmptyView = a.getBoolean(R.styleable.XListView_hasEmptyView, true);
        a.recycle();
        ...
        switch (ev.getAction()) {
            ...
            default:
                ...
                if (getFirstVisiblePosition() == 0) {
                    ...
                    mHandler.sendEmptyMessage(HANDLER_RESET_FOOTER_HEIGHT);
                }
                break;
        }
